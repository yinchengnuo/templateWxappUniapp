<template>
	<view class="router padding-sm">
		<view class="content">
			...
			<button class="url" @tap="$copy('https://ext.dcloud.net.cn/plugin?id=1089')">开源地址:https://ext.dcloud.net.cn/plugin?id=1089(点击复制)</button>
			...
			<view class="p">4. 支持路由拦截</view>
			<view class="p">5. 参数为特殊字符是传参异常</view>
			<view class="p">6. 防止快速连点处理</view>
			<view class="p">7. switchTab 传参</view>
			<view class="p">8. pop 传参</view>
		</view>
	</view>
</template>
