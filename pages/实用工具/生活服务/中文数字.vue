		...
		<template v-slot:default="{ page }">
			<template v-if="page">
				...
				<view class="cu-bar input">
					<input v-model.trim="text" ref="input" :focus="focus" class="my_input" confirm-type="search" placeholder="请输入数字"
				...
				<template v-if="result">
					<view class="cu-list menu sm-border card-menu margin-top margin-bottom">
						<view class="cu-item">
							<view class="content">
								<text class="text-lg text-black text-bold padding-top-xs padding-bottom-xs">{{ result }}</text>
							</view>
						</view>
					</view>
				</template>
