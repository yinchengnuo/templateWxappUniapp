...
<style lang="scss" scoped>
	...
	.dancers01:after {
		...
		background: #3FB8AF;
		animation:
			dancers01-1 2s infinite,
			dancers01-2 .5s infinite;
	}
	...
	.dancers02:after {
		...
		background: #3FB8AF;
		animation:
			dancers02-1 2s infinite,
			dancers02-2 1s infinite;
	}
	...
	.dancers04 {
		...
		animation:
			dancers04-1 1s infinite alternate,
			dancers04-2 .5s infinite alternate;
	}
	...
	.dancers05:before {
		...
		animation: dancers05-1 .5s infinite
	}
	...
	@keyframes dancers05-1 {
		100% {
			transform: translate(30px) rotate(.25turn)
		}
	}
	...
	.dancers07 {
		...
		background: #3FB8AF;
		animation:
			dancers07-1 1s infinite alternate,
			dancers07-2 2s infinite alternate;
	}
	...
	.dancers08:before {
		...
		animation: dancers08-1 .5s infinite alternate;
	}
	...
	.time10::after {
		...
		animation: time10-1 .5s infinite alternate linear;
	}
	...
	.time10::before {
		...
		background-repeat: no-repeat;
		transform-origin: 50% 3px;
		animation: time10-2 .5s infinite alternate linear;
	}
	...
	.nature16:before {
		...
		animation: nature16 .25s infinite linear alternate;
	}
	...
	.continuous10 {
		...
		-webkit-mask:
			conic-gradient(from 90deg at 5px 5px, #0000 25%, #000 0) 0 0/calc((100% - 5px)/5) calc(100% - 5px);
	...
	.flipping02 {
		...
		aspect-ratio: 1;
		animation:
			flipping02-1 2s infinite linear,
			flipping02-2 1s infinite steps(1) alternate;
	}
	...
	.flipping03 {
		...
		aspect-ratio: 1;
		animation:
			flipping03-1 2s infinite linear,
			flipping03-2 3s infinite steps(1) -.5s;
	}
	...
	.flipping04::before {
		...
		transform-origin: bottom;
		animation:
			flipping04-1 0.5s infinite linear alternate,
			flipping04-2 0.5s infinite steps(1) alternate;
	}
	...
	.flipping05::after {
		...
		animation:
			flipping05-1 0.5s infinite linear alternate,
			flipping05-2 0.5s infinite steps(1) alternate;
	}
	...
	.flipping06 {
		...
		animation:
			flipping06-0 1.5s infinite steps(1) alternate,
			flipping06-0-0 3s infinite steps(1);
	}
	...
	.flipping07::after {
		...
		transform-origin: bottom right;
		animation: flipping07-1 .5s infinite linear alternate;
	}
	...
	.flipping08::after {
		...
		flex: 1;
		animation:
			flipping08-1 1s infinite linear alternate,
			flipping08-2 2s infinite steps(1) -.5s;
	}
	...
	.flipping09 {
		...
		background-size: 50.1% 50.1%;
		animation:
			flipping09-0 1.5s infinite steps(1) alternate,
			flipping09-0-0 3s infinite steps(1) alternate;
	}
	...
	.flipping10::after {
		...
		flex: 1;
		animation:
			flipping10-1 1s infinite linear alternate,
			flipping10-2 2s infinite steps(1) -.5s;
	}
	...
	.flipping11::after {
		...
		animation:
			flipping11-1 1s infinite linear alternate,
			flipping11-2 2s infinite linear -.5s;
	}
	...
	.flipping12 {
		...
		aspect-ratio: 1;
		display: flex;
		animation: flipping12-0 4s infinite linear .5s;
	}
	...
	.flipping13 {
		...
		aspect-ratio: 1;
		display: flex;
		animation: flipping13-0 4s infinite linear .5s;
	}
	...
	.flipping14::after {
		content: "";
		flex: 1;
		animation: flipping14 1.5s -.25s infinite linear alternate both;
	}
	...
	.flipping15::after {
		...
		background: #FC3A51;
		animation:
			flipping15-1 1s infinite linear alternate,
			flipping15-2 2s infinite linear -.5s;
	}
	...
	.flipping16 {
		...
		background-repeat: no-repeat;
		animation: flipping16-0 2s infinite linear .25s;
	}
	...
	.flipping16::before {
		...
		height: 50%;
		background: currentColor;
		animation: flipping16-1 .5s infinite linear;
	}
	...
	.flipping17 {
		...
		background:
			...
			linear-gradient(currentColor 0 0) bottom /100% 51%;
		background-repeat: no-repeat;
		animation: flipping17-0 2s infinite linear .25s;
	}
	...
	.flipping17::before {
		...
		animation: flipping17-1 .5s infinite linear;
	}
	...
	.flipping18 {
		...
		background-repeat: no-repeat;
		animation: flipping18-0 2s infinite linear .25s;
	}
	...
	.flipping18::before {
		...
		animation: flipping18-1 .5s infinite linear;
	}
	...
	.wobbling04 {
		...
		clip-path: inset(0);
		animation:
			wobbling04-1 0.5s ease-in-out infinite alternate,
			wobbling04-2 1s ease-in-out infinite;
	}
	...
	.wobbling08 {
		...
		background: radial-gradient(at 30% 30%, #0000, #000a) red;
		animation: wobbling08 1s cubic-bezier(.5, -200, .5, 200) infinite;
	}
	...
	.wobbling09 {
		...
		background-repeat: no-repeat;
		animation: wobbling09 1s cubic-bezier(.5, -150, .5, 150) infinite;
	}
	...
	.wobbling13::after {
		...
		border-radius: 50%;
		background: radial-gradient(at 30% 30%, #0000, #000a) red;
		animation: wobbling13-1 0.5s cubic-bezier(.5, -500, .5, 500) infinite;
	}
	...
	.wobbling16:before {
		...
		animation: wobbling16-1 .5s infinite linear alternate;
	}
	...
	.wobbling17 {
		...
		animation:
			wobbling17-0 2s infinite alternate linear,
			wobbling17-1 2s infinite cubic-bezier(.75, 0, 1, .6);
	}
	...
	.shapes06:after {
		...
		background: #514b82;
		animation:
			shapes06-1 1.5s infinite linear,
			shapes06-2 1.5s infinite linear;
	}
	...
	.shapes29 {
		...
		animation:
			shapes29-1 .75s infinite alternate linear,
			shapes29-2 1.5s infinite;
	}
	...
	.shapes31 {
		...
		animation: shapes31 .5s infinite alternate;
	}
	...
	.shapes32 {
		...
		background-size: 16px 16px;
		animation:
			shapes32-1 1s infinite,
			shapes32-2 1s infinite;
	}
	...
	.shapes33 {
		...
		animation:
			shapes33-1 1.5s infinite,
			shapes33-2 1.5s infinite;
	}
	...
	.shapes34 {
		...
		background:
			...
			var(--c), var(--c);
		animation:
			shapes34-1 2s infinite alternate,
			shapes34-2 2s infinite alternate;
	}
	...
	.shapes39:before {
		...
		background-repeat: no-repeat;
		animation:
			shapes39-1 1s infinite,
			shapes39-2 1s infinite;
	}
	...
	.spinner20 {
		...
		animation:
			spinner20-1 0.8s infinite linear alternate,
			spinner20-2 1.6s infinite linear;
	}
