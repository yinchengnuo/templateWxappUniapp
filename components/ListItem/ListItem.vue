<template>
  <view class="index">
    <image src="https://mp-f3138cb7-2a3b-4344-8e79-a1f65871aab2.cdn.bspapp.com/ToolBox365/list_item_bg.svg" mode="widthFix" class="item_bg"></image>
    ...
    <view class="flex flex_sb">
      <view class="cuIcon-peoplefill text-progress"
        ><text style="margin-left: 8rpx; font-weight: bold">{{ item.user_num }}</text></view
      >
      <view class="cuIcon-favorfill text-orange"
        ><text style="margin-left: 8rpx; font-weight: bold">{{ item.collect_num }}</text></view
      >
