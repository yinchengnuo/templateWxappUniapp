<template>
	<view class="index">
		...
		<view class="flex flex_sb">
			<view class="cuIcon-peoplefill text-progress"><text
					style="margin-left: 8rpx;font-weight: bold;">{{item.user_num}}</text></view>
			<view class="cuIcon-favorfill text-orange"><text
					style="margin-left: 8rpx;font-weight: bold;">{{item.collect_num}}</text></view>
			<text class="cuIcon-attentionfill text-black"><text
					style="margin: 0 28rpx 0 8rpx;font-weight: bold">{{item.view_num}}</text>
			</text>
		</view>
	</view>
</template>
