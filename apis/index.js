...
export const _API_MsgSecCheck = data => request.post('/msg_sec_check', data) // 检测文字

export const _API_Index = data => request.get('/', data) // 获取 index 首页数据

export const _API_IndexUpload = data => request.uploadFile('/user/auth_share', data) // 上传文件接口
